  ...
  <div class="relative">
    <header>
      <nav :class="{ 'fixed-nav': true, 'nav-hidden': isHidden }" class="py-4 px-4 md:px-20 ">
        <ul
          class="backdrop-blur-lg links text-base justify-between tracking-wide text-stone-300 ml-auto flex gap-4 md:gap-12 items-end rounded-3xl m-auto bg-stone-900 hover:bg-stone-950 transition duration-100 shadow-sm py-2 md:py-3 px-6 md:px-8 uppercase font-bold border-2 border-stone-200 hover:border-stone-600 bg-opacity-50 w-full">
          <li>
