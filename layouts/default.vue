  ...
  <div class="relative">
    <header>
      <nav :class="{'fixed-nav': true, 'nav-hidden': isHidden}" class="py-10 px-20">
        <ul class="text-xl tracking-wide text-stone-300 ml-auto flex gap-20 items-end w-full m-auto bg-stone-900 hover:bg-stone-950 transition duration-100 shadow-sm py-4 px-8 uppercase font-bold border-2 border-stone-200 hover:border-stone-600 bg-opacity-50 w-full">
